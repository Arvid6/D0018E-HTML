        ...
        <div class="dropdown">
            ...
            <div class="content">
                ...
                while($row = $lol->fetch_assoc()) {
                    ...
                    $img = "img/" . $Name . ".png";
                    ?>
                <a  href="extrasidor.php?id=<?php echo $product_ids; ?>" style="color: black; text-decoration: none;"> <img src="<?php echo $img?>" height="30px" width="30px"><?php echo $Name, " | ", $TotalAmount ; ?>  </a>
